...
class HotspotController extends Controller
{
    ...
    public function createUserProfile()
    {
        ...
        $record = '; :local mac $"mac-address"; :local time [/system clock get time ]; /system script add name="$date-|-$time-|-$user-|-'.$price.'-|-$address-|-$mac-|-' . $validity . '-|-'.$name.'-|-$comment" owner="$month$year" source=$date comment=mikrotikbot';
...
//                })
    ...
    public function updateProfile()
    {
        ...
        try {
            $this->hotspotRepository->updateUserProfile($id, $name, $addrpool, $ratelimit, $sharedusers, $onlogin, $parent);
    ...
    public function destroy()
    {
        ...
        $success = $this->hotspotRepository->removeUserProfile($id);
